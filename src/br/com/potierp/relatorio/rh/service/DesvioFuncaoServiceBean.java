 ...
 *
 */
@Stateless(mappedName = "DesvioFuncaoService", name="DesvioFuncaoService")
@Local(DesvioFuncaoService.class)
@Interceptors(DAOInterceptor.class)
public class DesvioFuncaoServiceBean implements
		DesvioFuncaoService {

	/* (non-Javadoc)
	 * @see br.com.potierp.relatorio.rh.service.DesvioFuncaoService#getRelatorio(java.util.List)
	 */
	@Override
	...
	private List<JasperReportUtilHelper> getListJasperReportUtilHelper(
		...
		for(Funcionario funcionario : listFuncionario){
			...
			jasperReportUtilHelper.setOrigem("DesvioFuncao.jasper");
