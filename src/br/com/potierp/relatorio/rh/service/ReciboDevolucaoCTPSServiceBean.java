 ...
 */
@Stateless(mappedName = "ReciboDevolucaoCTPSService", name="ReciboDevolucaoCTPSService")
@Local(ReciboDevolucaoCTPSService.class)
@Interceptors(DAOInterceptor.class)
public class ReciboDevolucaoCTPSServiceBean implements ReciboDevolucaoCTPSService {
	...
	public byte[] getRelatorio(List<Funcionario> listFuncionario)
		...
		try {
			...
			throw new PotiErpException(
					...
					new Object[] { "Recibo de Devolução da CTPS" }, e);
		}
	}
	...
	private List<JasperReportUtilHelper> getListJasperReportUtilHelper(
		...
		for(Funcionario funcionario : listFuncionario){
			...
			jasperReportUtilHelper.setOrigem("ReciboDevolucaoCTPS.jasper");
