...
@Stateless(mappedName = "AutorizacaoDescontoRefeicaoMundialService", name="AutorizacaoDescontoRefeicaoMundialService")
@Local(AutorizacaoDescontoRefeicaoMundialService.class)
@Interceptors(DAOInterceptor.class)
public class AutorizacaoDescontoRefeicaoMundialServiceBean implements
		AutorizacaoDescontoRefeicaoMundialService {
	...
	private List<JasperReportUtilHelper> getListJasperReportUtilHelper(
		...
		for(Funcionario funcionario : listFuncionario){
			...
			jasperReportUtilHelper.setOrigem("AutorizacaoDescontoRefeicao.jasper");
