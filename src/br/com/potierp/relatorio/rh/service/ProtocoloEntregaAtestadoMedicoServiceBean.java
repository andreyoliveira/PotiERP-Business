 ...
 */
@Stateless(mappedName = "ProtocoloEntregaAtestadoMedicoService", name="ProtocoloEntregaAtestadoMedicoService")
@Local(ProtocoloEntregaAtestadoMedicoService.class)
@Interceptors(DAOInterceptor.class)
public class ProtocoloEntregaAtestadoMedicoServiceBean implements
		ProtocoloEntregaAtestadoMedicoService {
	...
	public byte[] getRelatorio(List<Funcionario> listFuncionario)
		...
		try {
			...
			throw new PotiErpException(
					...
					new Object[] { "Protocolo de Entrega de Atestado Médico" }, e);
		}
	}
	...
	private List<JasperReportUtilHelper> getListJasperReportUtilHelper(
		...
		for(Funcionario funcionario : listFuncionario){
			...
			jasperReportUtilHelper.setOrigem("ProtocoloEntregaAtestadoMedico.jasper");
